...
// Heading
$_['heading_title'] = 'ATM (ZaloPay Gateway)';
...
$_['text_zalopay_atm'] = '<a href="https://zalopay.vn/" target="_blank"><img width="109" src="view/image/payment/zalopay.png" alt="Zalopay" title="ZaloPay" style="border: 1px solid #EEEEEE;" /></a>';
